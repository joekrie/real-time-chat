...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatClient = __webpack_require__(159);

	var _ChatClient2 = _interopRequireDefault(_ChatClient);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_ChatClient2.default, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qwest = __webpack_require__(210);

	var _qwest2 = _interopRequireDefault(_qwest);

	var _Messages = __webpack_require__(214);

	var _Messages2 = _interopRequireDefault(_Messages);

	var _MessageSender = __webpack_require__(215);
	...
	var ChatClient = function (_Component) {
	  _inherits(ChatClient, _Component);

	  function ChatClient(props) {
	    _classCallCheck(this, ChatClient);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChatClient).call(this, props));
	  ...
	  _createClass(ChatClient, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.socket.on('new-message', function (msg) {
	        var newMessages = _this2.state.messages.slice();
	        newMessages.push(msg);
	        _this2.setState({ messages: newMessages });
	      });

	      _qwest2.default.get('/all-messages').then(function (xhr, resp) {
	        return _this2.setState({ messages: resp });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var sendMessage = function sendMessage(message) {
	        return _this3.socket.emit('new-message', { message: message });
	      };
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_MessageSender2.default, { sendMessage: sendMessage })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
		...
		var global = window || this,
			pinkyswear = __webpack_require__(211),
			jparam = __webpack_require__(213),
			defaultOptions = {},
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(168)(module), __webpack_require__(212).setImmediate, __webpack_require__(4)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Messages = function Messages(_ref) {
	  ...
	  var messageItems = messages.map(function (msg) {
	    return _react2.default.createElement(
	      'li',
	      { key: msg._id },
	      msg.message
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageSender = function MessageSender(_ref) {
	  ...
	  var submitForm = function submitForm(evt) {
	    evt.preventDefault();
